...
-- If not, create one:
-- Snowflake generates STORAGE_AWS_EXTERNAL_ID automatically.
-- After creating, run: DESC INTEGRATION s3_iceberg_integration;
-- Use STORAGE_AWS_EXTERNAL_ID + STORAGE_AWS_IAM_USER_ARN in your AWS IAM role Trust Policy.
-- See: docs/STORAGE_AWS_EXTERNAL_ID.md
